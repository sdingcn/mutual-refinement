...
void Grammar::addNonterminal(int nt) { nonterminals.insert(nt); }

void Grammar::addStartSymbol(int s) { startSymbol = s; }

void Grammar::addEmptyProduction(int l) { emptyProductions.push_back(l); }
